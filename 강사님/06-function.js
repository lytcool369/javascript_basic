...
// arguments 배열로 전달
function getTotal() {   // 매개 변수 선언 없음
    let result = 0;

    // 모든 전달된 인수는 argument로 전달
...
console.log("getTotal:", getTotal(1, 2, "3", 4, 5));    // 해당 함수에서 타입체크를 안하면 이상한 숫자 출력

// 자바스크립트의 삼수는 그 자체로 객체다
