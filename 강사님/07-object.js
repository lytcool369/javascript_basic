// 자바스크립트의 객체
//      객체 기반 언어 -> 클래스 없음
//      동적으로 필요할 때 언제든 속성(프로퍼티, 메서드를 추가 할 수 있다.)
...
m1.sayHi();     // OK
// m2.sayHi();  // m1 에 추가된 속성 이므로, m2 에서는 불러올 수 없다.

// prototype 영역 확인 -> 공유 영역
console.log(Member.prototype);
// prototype 영역에 속성을 추가하면 
// 해당 객체를 공유하는 모든 인스턴스에서 공유
