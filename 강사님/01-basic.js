...
var testVar = 10;   // ES6 이전에 변수를 할당하는 방법
                    // WEB 환경에서 var를 사용하도록 하자

let tsetLet = "let variable";   // 재할당 가능 변수
const TEST_CONST = "constant";  // 재할당 불가 변수

console.log(testVar, tsetLet, TEST_CONST);

testVar = "var changed";
testLet = "let changed";
// TEST_CONST = "constant changed";     -> 재할당 불가 (const는 선언과 동시에 할당해야 한다.)
