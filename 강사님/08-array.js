// 배열의 생성: 객체 이용생성
const a1 = new Array(10);               // 10개 짜리의 빈 배열
...
const ingrs = veges.concat(sources);    // veges 배열에 sorces 배열 연결
...
// 잘라내기: slice
let slices = fruits.slice(1, 3);    // 1 ~ 2 인덱스까지
...
// splice
// 배열의 추출, 삽입, 삭제를 하넙ㄴ에 할 수 있는 메서드
fruits = ["Banana", "Orange", "Apple", "Mango"];
console.log("원본", fruits);
console.log("SPLICE: ", fruits.splice(2));      // 인수가 1개 -> 인덱스부터 끝까지 추출 후 제거
console.log("이후 원본:", fruits);

fruits = ["Banana", "Orange", "Apple", "Mango"];
console.log("원본", fruits);
console.log("SPLICE: ", fruits.splice(1, 2));   // 인수가 2개 -> 인덱스부터 갯수 지정, 추출 후 제거
console.log("이후 원본:", fruits);

fruits = ["Banana", "Orange", "Apple", "Mango"];
console.log("SPLICE:", fruits.splice(1, 2, "Kiwi", "Orange"));  // 인수가 3개 이상 -> 인덱스부터 갯수 지정 추출 후 제거 후 새 요소 삽입
console.log("이후 원본:", fruits);